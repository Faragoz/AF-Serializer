...
if __name__ == "__main__":
    ...
    buffer = bytes.fromhex("180080000000000300080030ffffffff0005000400000a0050000200000001000100020000000474657374000000000000000000000000")
    data = deserialize_variant(buffer)
    print(data)
